...
<motion.div className='flex flex-col gap-7 w-full max-w-[690px] leading-14 flex-wrap items-center justify-center md:items-start' variants = {slideChildContainer}>
